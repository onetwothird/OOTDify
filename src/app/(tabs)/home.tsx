...
import { View, Text, StyleSheet, ScrollView, Image, TouchableOpacity, ActivityIndicator, BackHandler, Modal } from 'react-native';
    ...
    <>
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 120 }}>
        ...
        <View style={styles.scheduleCard}>
          ...
          <View style={styles.weatherInfo}>
            {isLoading ? (
              ...
              <>
                <Ionicons name={getWeatherIcon(weatherData.weather[0].main)} size={20} color="#A1A1AA" />
        ...
        <View style={styles.mainCard}>
          <Image source={{ uri: 'https://images.unsplash.com/photo-1584273143981-41c073dfe8f8?auto=format&fit=crop&w=800&q=80' }} style={styles.cardImage} />
...
const styles = StyleSheet.create({
  ...
  locationText: { fontSize: 14, color: '#71717A', fontWeight: '500', marginLeft: 4 },
  scheduleCard: { flexDirection: 'row', backgroundColor: '#F4F4F5', borderRadius: 20, padding: 16, alignItems: 'center', marginBottom: 32 },
  dateBadge: { backgroundColor: '#FFFFFF', borderRadius: 12, paddingVertical: 8, paddingHorizontal: 10, alignItems: 'center', marginRight: 16, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 4, elevation: 2 },
  dateDay: { fontSize: 10, fontWeight: '700', color: '#3F3F46', marginBottom: 2 },
  dateNumber: { fontSize: 16, fontWeight: '800', color: '#18181B' },
  scheduleInfo: { flex: 1 },
  scheduleTitle: { fontSize: 15, fontWeight: '700', color: '#18181B', marginBottom: 4 },
  scheduleTime: { fontSize: 13, color: '#71717A', fontWeight: '500' },
  weatherInfo: { flexDirection: 'row', alignItems: 'center' },
  weatherTemp: { fontSize: 16, fontWeight: '700', color: '#18181B', marginLeft: 6 },
  ...
  mainCard: { backgroundColor: '#FFFFFF', borderRadius: 24, padding: 16, borderWidth: 1, borderColor: '#F4F4F5', shadowColor: '#000', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.06, shadowRadius: 24, elevation: 5 },
  cardImage: { width: '100%', height: 340, borderRadius: 16, resizeMode: 'cover', marginBottom: 20 },
  ...
  bookmarkBtn: { backgroundColor: '#18181B', width: 44, height: 44, borderRadius: 14, justifyContent: 'center', alignItems: 'center' },
